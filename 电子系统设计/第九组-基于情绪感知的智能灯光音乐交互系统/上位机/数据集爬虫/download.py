...
def download_playlist(playlist_id, download_path="./Dataset"):
...
if __name__ == "__main__":
    playlist_id = input("歌单ID：") #2462150626, 21692844...
    # 尽量多选一些歌单,增加多样性
    download_path = input(r"下载路径（默认为 ./Dataset/）：") or r"./Dataset"

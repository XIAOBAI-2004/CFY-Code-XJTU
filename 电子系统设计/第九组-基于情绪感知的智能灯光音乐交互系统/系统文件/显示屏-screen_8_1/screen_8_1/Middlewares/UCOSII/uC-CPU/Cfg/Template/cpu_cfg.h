...
*********************************************************************************************************
*/
/*  改动 是否使用CPU名字：DEF_ENABLED或者DEF_DISABLED 在debug的时候可能用到      */
...
*********************************************************************************************************
*/
/*  改动 是否使用32位的时间戳变量：DEF_ENABLED或者DEF_DISABLED             */
...
*********************************************************************************************************
*/
/* 改动 是否使用CPU前导零指令（需要硬件支持，在stm32我们可以使用这个指令） */
